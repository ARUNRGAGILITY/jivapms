...
from __APPNAME__.mod___OBJECT__.models___OBJECT__ import *

class __OBJECTMODEL__Form(forms.ModelForm):
    class Meta:
        model = __OBJECTMODEL__
        fields = ['name', 'description']
    def __init__(self, *args, **kwargs):
        super(__OBJECTMODEL__Form, self).__init__(*args, **kwargs)
...
from __APPNAME__.mod___OBJECT__ import views___OBJECT__


urlpatterns = [
    # __APPNAME__/__OBJECTPLURAL__: DB/Model: __OBJECTMODEL__
    path('list___OBJECTPLURAL__/<int:__PARENTOBJECTID__>/', views___OBJECT__.list___OBJECTPLURAL__, name='list___OBJECTPLURAL__'),
    path('list_deleted___OBJECTPLURAL__/<int:__PARENTOBJECTID__>/', views___OBJECT__.list_deleted___OBJECTPLURAL__, name='list_deleted___OBJECTPLURAL__'),
    path('create___OBJECT__/<int:__PARENTOBJECTID__>/', views___OBJECT__.create___OBJECT__, name='create___OBJECT__'),
    path('edit___OBJECT__/<int:__PARENTOBJECTID__>/<int:__SECONDID__>/', views___OBJECT__.edit___OBJECT__, name='edit___OBJECT__'),
    path('delete___OBJECT__/<int:__PARENTOBJECTID__>/<int:__SECONDID__>/', views___OBJECT__.delete___OBJECT__, name='delete___OBJECT__'),
    path('permanent_deletion___OBJECT__/<int:__PARENTOBJECTID__>/<int:__SECONDID__>/', views___OBJECT__.permanent_deletion___OBJECT__, name='permanent_deletion___OBJECT__'),
    path('restore___OBJECT__/<int:__PARENTOBJECTID__>/<int:__SECONDID__>/', views___OBJECT__.restore___OBJECT__, name='restore___OBJECT__'),
    path('view___OBJECT__/<int:__PARENTOBJECTID__>/<int:__SECONDID__>/', views___OBJECT__.view___OBJECT__, name='view___OBJECT__'),
]
"""
...
from __PARENTAPPNAME__.mod___PARENTOBJECTSINGULAR__.models___PARENTOBJECTSINGULAR__ import *
from app_common.mod_common.models_common import *

class __OBJECTMODEL__(BaseModelImpl):
    __PARENTOBJECTFKREF__ = models.ForeignKey('__PARENTAPPNAME__.__PARENTOBJECTMODEL__', on_delete=models.CASCADE, 
                            related_name="__PARENTOBJECTFKREF____OBJECTPLURAL__", null=True, blank=True)
    
    author = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True,
                               related_name="author___OBJECTPLURAL__")
...
var_value_dict = {
    ...
    # Module info
    "__MODNAME__": module_name.capitalize(),
    "__MODULEPATH__": module_path,
    "__DBAPPNAME__": db_app_name,
    
    # Current object info
    "__OBJECT__": singular_module_name.lower(),
    "__OBJECTPLURAL__": lc_plural_module_name,
    "__OBJECTFLUC__": singular_module_name.capitalize(),
    "__OBJECTMODEL__": model_name,
    "__DISPLAYOBJECTNAME__": display_module_name,
    "__DISPLAYOBJECTNAMESINGULAR__": display_module_name_singular,
    "__SECONDID__": second_id,
    
    # Parent object info
    "__PARENTOBJECT__": first_name,
    "__PARENTOBJECTMODEL__": first_model_name,
    "__PARENTOBJECTID__": first_id,
    "__PARENTOBJECTFKREF__": first_id_fk_ref,
    "__PARENTAPPNAME__": first_app_name,
    "__PARENTOBJECTMODELIMPORT__": first_model_name_import,
    "__PARENTOBJECTSINGULAR__": singular_firstmodule_name,
    "__PARENTOBJECTPLURAL__": plural_firstmodule_name,
    "__PARENTOBJECTPLURALFLUC__": plural_firstmodule_name.capitalize(),
    
    # Special fixes
    "__ORGFIX__": org_fix,
    "__ORGPARAMFIX__": org_param_fix
}
...
def replace_all_vars_with_values(var_value_dict, file_data):
    # First replace the new variable styles
    for var, value in var_value_dict.items():
        file_data = file_data.replace(var, value)
    
    # For backward compatibility - map the new vars to old vars
    compatibility_mapping = {
        "__APPNAME__": "___APPNAME___",
        "__APPVERSION__": "___appversion___",
        "__MODNAME__": "___MODNAME___",
        "__MODULEPATH__": "___modulepath___",
        "__OBJECTMODEL__": "___MODELNAME___",
        "__DISPLAYOBJECTNAME__": "___DISPMODNAME___",
        "__DISPLAYOBJECTNAMESINGULAR__": "___DISPMODNAMESINGULAR___",
        "__OBJECT__": "___singularmodname___",
        "__OBJECTPLURAL__": "___pluralmodname___",
        "__OBJECTFLUC__": "___UCsingularmodname___",
        "__PARENTOBJECTID__": "___firstid___",
        "__PARENTOBJECT__": "___firstname___",
        "__PARENTOBJECTFKREF__": "___firstidfkref___",
        "__PARENTOBJECTMODEL__": "___FIRSTMODELNAME___",
        "__SECONDID__": "___secondid___",
        "__PARENTAPPNAME__": "___firstappname___",
        "__PARENTOBJECTSINGULAR__": "__singularfirstmodname___",
        "__PARENTOBJECTPLURAL__": "__pluralfirstmodname___",
        "__PARENTOBJECTPLURALFLUC__": "__pluralfirstmodnameuc___",
        "__ORGFIX__": "___ORGFIX1___",
        "__ORGPARAMFIX__": "___ORGPARAMFIX1___"
    }
    
    # Replace old-style variables for backward compatibility
    for new_var, old_var in compatibility_mapping.items():
        if new_var in var_value_dict:
            file_data = file_data.replace(old_var, var_value_dict[new_var])
